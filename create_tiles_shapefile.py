...
def create_shapefile_latlng(fd, extent, level):
    ...
    for tile in create_tiles.create_google_tiles_lnglat(level, extent):
        lng_min, lng_max, lat_min, lat_max = tile[-1]
        wr.shapePolygon([((lng_min,lat_min),(lng_min,lat_max),(lng_max,lat_max),(lng_max,lat_min),(lng_min,lat_min))])
...
if __name__ == '__main__':
    ...
    for level in range(8):
        create_shapefile_latlng(fd, extent, level)
